...
class MyModelController {
  static async create(req, res, next) {
    try {
      ...
      const newMyModel = await MyModelService
        .create(varchar255NotNull, integerUniqueNotNull, dateStdNow, dateTime, booleanStd, );
  ...
  static async update(req, res, next) {
    try {
      ...
      const updatedMyModel = await MyModelService.update(id, varchar255NotNull, integerUniqueNotNull, dateStdNow, dateTime, booleanStd, );
  ...
  static async partialUpdate(req, res, next) {
    try {
      ...
      const updatedMyModel = await MyModelService.partialUpdate(id, varchar255NotNull, integerUniqueNotNull, dateStdNow, dateTime, booleanStd, );
